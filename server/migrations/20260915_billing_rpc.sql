...
create table if not exists credit_ledger (
  ...
  kind text not null check (kind in ('ai_reserve', 'ai_settle', 'ai_release')),
...
revoke all on billing_settings,membership_entitlements,daily_token_quotas,
  credit_wallets,ai_operations,credit_ledger,content_updates,reading_nodes from public;
